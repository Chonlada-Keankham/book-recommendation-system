...
export class CommentController {
  ...
  @Post('create-comment')
  @ApiOperation({ summary: 'Create a new comment on a book' })
  ...
  async updateReply(
    ...
    const userId = req.user['_id'];
    const reply = await this.commentService.updateReply(
      commentId,
      replyId,
      updateReplyDto,
      userId,
  ...
  @Get('book/:bookId')
  @ApiOperation({ summary: 'Find all comments and replies for a book' })
